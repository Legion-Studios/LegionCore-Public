    ...
    class ls_vehicle_aat_base: Tank_F {
        ...
        class TextureSources {
            ...
            class CIS: TradeFederation {
                displayname = "CIS";
                textures[] = {
                    QPATHTOF(data\textures\CIS\CIS_body1_CO.paa),
                    QPATHTOF(data\textures\CIS\CIS_body2_CO.paa),
                    QPATHTOF(data\textures\CIS\CIS_gun_CO.paa)
                };
            };

            class Blue: TradeFederation {
                displayname = "CIS - Old";
                textures[] = {
                    QPATHTOF(data\textures\blue\body1_co.paa),
                    QPATHTOF(data\textures\blue\body2_co.paa),
                    QPATHTOF(data\textures\blue\gun_co.paa)
                };
            };
