...
//aat sounds
soundEngineOnInt[] = {QPATHTOEF(sounds,vehicles\aat\misc\start_int.wss), 0.79432797, 1};
soundEngineOffInt[] = {QPATHTOEF(sounds,vehicles\aat\misc\stop_int.wss), 0.79432797, 1};
soundEngineOnExt[] = {QPATHTOEF(sounds,vehicles\aat\misc\start_ext.wss), 1.99526, 1, 100};
soundEngineOffExt[] = {QPATHTOEF(sounds,vehicles\aat\misc\stop_ext.wss), 1.99526, 1, 100};
// Get in/out sounds
