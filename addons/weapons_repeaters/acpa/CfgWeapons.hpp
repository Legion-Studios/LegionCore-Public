class ls_weapon_acpa_base: ls_rifle_base {
    ...
    author = AUTHOR;
    displayName = "ACP-A";
    descriptionShort = "Accelerated Charged Particle - Array Gun";
    ...
    handAnim[] = {
        "OFP2_ManSkeleton",
        QPATHTOF(acpa\anims\acpa_handanim.rtm)
    };
    ...
    reloadMagazineSound[] = {QPATHTOEF(sounds,weapons\reload\acpa.ogg), 0.56234133, 1, 30};
    ...
    class Single: Mode_SemiAuto {
        ...
        class StandardSound {
            begin1[] = {QPATHTOEF(sounds,weapons\acpa\shot1.wss), 1, 1, 1800};
            soundBegin[] = {"begin1", 1};
        };
        reloadTime = 0.6;
        dispersion = 0.003015;
