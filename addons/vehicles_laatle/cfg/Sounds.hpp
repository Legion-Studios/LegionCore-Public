//Basic Sounds
soundEngineOnInt[] = {QPATHTOEF(sounds,vehicles\laat\engine\engine_start_int.wss), 0.316228, 1};
soundEngineOnExt[] = {QPATHTOEF(sounds,vehicles\laat\engine\engine_start_ext.wss), 0.794328, 1, 600};
soundEngineOffInt[] = {QPATHTOEF(sounds,vehicles\laat\engine\engine_end_int.wss), 0.316228, 1};
soundEngineOffExt[] = {QPATHTOEF(sounds,vehicles\laat\engine\engine_end_ext.wss), 0.794328, 1, 600};
...
class Sounds {
    class EngineInt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatle\engine\engine_ext.wss), 0.794328, 1};
        frequency = "rotorSpeed*(1+rotorThrust/6)*0.8";
        volume = "2 * (1-camPos)*(rotorSpeed factor[0.4,1])";
    };

    class EngineExt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatle\engine\engine_int.wss), 1.25893, 1, 600};
        frequency = "rotorSpeed*(1+rotorThrust/6)*0.8";
        volume = "camPos*((rotorSpeed-0.72)*4)";
    };

    class RotorNoiseExt   {
        sound[] = {QPATHTOEF(sounds,vehicles\laatle\rotor_swist.wss), 0.707946, 1, 800};
        frequency = 1;
    ...
    class damageAlarmInt {
        sound[] = {"A3\Sounds_F\vehicles\air\noises\heli_alarm_opfor.wss", 0.316228, 1};
        frequency = 1;
        volume = "engineOn * (1 - camPos) * ( 1 - ((transmissionDamage factor [0.61, 0.60]) * (motorDamage factor [0.61, 0.60]) * (rotorDamage factor [0.51, 0.50]))) * (rotorSpeed factor [0.0, 0.001])";
    };

    class damageAlarmExt {
        sound[] = {"A3\Sounds_F\vehicles\air\noises\heli_alarm_opfor.wss", 0.223872, 1, 20};
        frequency = 1;
    ...
    class SpeedStress  {
        sound[] = {"A3\Sounds_F\vehicles\noises\vehicle_stress3.wss", 0.707946, 1, 50};
        frequency = 1;
