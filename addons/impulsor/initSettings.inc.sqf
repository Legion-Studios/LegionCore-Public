...
[
    ...
    _category, [
        [0, 1, 2], [ELSTRING(common,disabled), "Hint", "Local Chat"], 1
    ]
] call CBA_fnc_addSetting;
...
[
    QGVAR(enableImpulseOnGround), "CHECKBOX",
    ["Can Impulse on Ground", "If enabled, vehicles can impulse while landed on the ground.\nNote that impulsing parallel to the ground will likely cause the vehicle to explode."],
    _category, false
] call CBA_fnc_addSetting;
