...
params ["_vehicle", "_impulseSettings", "_impulseLevel", "_impulseLevelOld"];
TRACE_4("fnc_levelChanged",_vehicle,_impulseSettings,_impulseLevel,_impulseLevelOld);

if (_impulseLevelOld > MODE_IMPULSE) then {
