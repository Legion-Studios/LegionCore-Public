...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            QMODULE(ToggleCamo),
            QMODULE(DeleteGroups),
            QMODULE(AreaHeal),
            QMODULE(AddReinsertAction),
            QMODULE(AddReinsertAction_zeus),
            QMODULE(BreachDoor),
            QMODULE(SetSkills),
            QMODULE(MountATRT),
            QMODULE(DismountATRT),
            QMODULE(AircraftSpawner),
            QMODULE(AircraftSpawner_zeus),
