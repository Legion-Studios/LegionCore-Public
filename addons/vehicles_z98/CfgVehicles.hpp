...
class CfgVehicles {
    ...
    class ls_vehicle_z98_base: VTOL_Base_F {
        ...
        model = QPATHTOF(ls_vehicle_z98.p3d);
        icon = QPATHTOEF(vehicles_z98,data\ui\Map_Z95_vehicle_CA.paa);
        overviewPicture = "\A3\Data_F_Exp\Images\VehicleXian_ca.paa";
        editorPreview = QPATHTOF(data\ui\editorPreviews\ls_vehicle_z98.jpg);
        ...
        class Exhausts {
            class Exhaust_main {
                position = "exhaust_l_l_pos";
                direction = "exhaust_l_l_dir";
                effect = "ExhaustsEffectPlane";
            };
            class Exhaust_main2 {
                position = "exhaust_l_u_pos";
                direction = "exhaust_l_u_dir";
                effect = "ExhaustsEffectPlane";
            };
            class Exhaust_main3 {
                position = "exhaust_r_u_pos";
                direction = "exhaust_r_u_dir";
                effect = "ExhaustsEffectPlane";
            };
            class Exhaust_main4 {
                position = "exhaust_r_l_pos";
                direction = "exhaust_r_l_dir";
                effect = "ExhaustsEffectPlane";
            };
        };
        ...
        memorypointGun[] = { "laser_l_i_pos","laser_l_o_pos","laser_r_i_pos","laser_r_o_pos"};
        gunBeg[] = { "laser_l_i_dir","laser_l_o_dir","laser_r_i_dir","laser_r_o_dir" };
        gunEnd[] = {"laser_l_i_pos","laser_l_o_pos","laser_r_i_pos","laser_r_o_pos" };
        ...
        class HitPoints: HitPoints {
            ...
            class HitFuel: HitHull {
                ...
                radius = 0.08;
                minimalHit = 0.0099999998;
                depends = "(hitEngine + hitEngine2 + hitEngine3 + hitEngine4) / 4";
            };
            ...
            class HitLCRudder: HitHull {
                ...
                radius = 0.2;
                minimalHit = 0.01;
                depends = "(hitEngine + hitEngine2)/2";
            };
            class HitRRudder: HitLCRudder {
                ...
                radius = 0.2;
                minimalHit = 0.01;
                depends = "(hitEngine3 + hitEngine4)/2";
            };
        ...
        class AnimationSources: AnimationSources {
            ...
            class wing_l_vibrate {
                source = "user";
                animPeriod = 1;
                initPhase = 0.5;
            };
            class wing_r_vibrate: wing_l_vibrate {};
        };
        lightOnGear = 1;
        aggregateReflectors[] = {
            {
        ...
        class Components: Components {
            ...
            class TransportPylonsComponent {
                UIPicture = QPATHTOEF(vehicles_z95,data\ui\Z95_3DEN_CA.paa);
                class pylons {
                    class pylons1 {
                        hardpoints[] = {"B_BIM9X_RAIL", "B_BIM9X_DUAL_RAIL", "B_AMRAAM_D_RAIL", "B_AMRAAM_D_DUAL_RAIL", "B_HARM_RAIL"};
                    ...
                    class pylons3: pylons1 {
                        hardpoints[]= {
                            "B_BIM9X_RAIL", "B_BIM9X_DUAL_RAIL", "B_AMRAAM_D_RAIL", "B_AMRAAM_D_DUAL_RAIL", "B_HARM_RAIL"
                        };
                        attachment="PylonRack_1Rnd_Missile_AA_04_F";
                        priority=9;
                        maxweight=2500;
                    ...
                    class pylons5: pylons1 {
                        hardpoints[]= {
                            "B_MISSILE_PYLON", "B_BIM9X_RAIL", "B_BIM9X_DUAL_RAIL", "B_AMRAAM_D_RAIL", "B_AMRAAM_D_DUAL_RAIL", "B_HARM_RAIL"
                        };
    ...
    class ls_vehicle_z98: ls_vehicle_z98_base {
        scope = 2;
        scopeCurator = 2; // VTOL_Base_F defines scopeCurator
        author = AUTHOR;
        displayName = "Z-98 Interceptor";
        side = 2;
        faction = "ls_mercenaries";
        crew = "ls_mandalorian_traditionalRTO";
        typicalCargo[] = {
        ...
        class TextureSources {
            ...
            class Grey: Standard {
                displayName = "Grey";
                textures[] = {
                    QPATHTOF(data\hull_grey_co.paa),
                    QPATHTOF(data\cockpit_co.paa)
                };
            };
        };
    ...
    class ls_vehicle_z98_grey: ls_vehicle_z98 {
        author = AUTHOR;
        displayName = "Z-98 Interceptor (Grey)";
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\hull_grey_co.paa),
            QPATHTOF(data\cockpit_co.paa),
        };
        editorPreview = QPATHTOF(data\ui\editorPreviews\ls_vehicle_z98_grey.jpg);
    };
};
