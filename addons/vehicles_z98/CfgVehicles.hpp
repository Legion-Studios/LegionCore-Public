...
class CfgVehicles {
    ...
    class ls_vehicle_z98_base: VTOL_Base_F {
        ...
        picture = QPATHTOF(data\ui\z98_icon_side_ca.paa);
        icon = QPATHTOF(data\ui\z98_icon_ca.paa);
        ...
        class Components: Components {
            ...
            class TransportPylonsComponent {
                UIPicture = QPATHTOF(data\ui\z98_3den_ca.paa);
                class pylons {
                    class pylons1 {
