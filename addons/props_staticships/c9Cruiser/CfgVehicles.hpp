class ls_staticShip_c9LightCruiser: ls_staticShip_base {
    ...
    EGVAR(map,icon) = QPATHTOF(data\ui\map\c9Cruiser_ui_ca.paa);
    EGVAR(map,name) = "CEC C9 Light Cruiser";
...
class ls_staticShip_c9LightCruiser_republic: ls_staticShip_c9LightCruiser {
    ...
    EGVAR(map,icon) = QPATHTOF(data\ui\map\c9Cruiser_republic_ui_ca.paa);
...
class ls_staticShip_c9LightCruiser_newRepublic: ls_staticShip_c9LightCruiser {
    ...
    EGVAR(map,icon) = QPATHTOF(data\ui\map\c9Cruiser_newRepublic_ui_ca.paa);
