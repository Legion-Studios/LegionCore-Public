class ls_staticShip_acclamator: ls_staticShip_base {
    ...
    EGVAR(map,icon) = QPATHTOF(data\ui\map\acclamator_ui_ca.paa);
    EGVAR(map,name) = "Acclamator";
...
class ls_staticShip_acclamator_landed: ls_staticShip_acclamator {
    ...
    EGVAR(map,icon) = QPATHTOF(data\ui\map\acclamator_landed_ui_ca.paa);
    EGVAR(map,name) = "Landed Acclamator";
...
class ls_staticShip_acclamator_landed_hollow: ls_staticShip_acclamator_landed {
    author = AUTHOR;
...
class ls_staticShip_acclamator_landed_noRamp: ls_staticShip_acclamator_landed {
    author = AUTHOR;
    displayName = "Acclamator Landed (No Ramp)";

    EGVAR(map,icon) = QPATHTOF(data\ui\map\acclamator_landed_noRamp_ui_ca.paa);
...
class ls_staticShip_acclamator_landed_hollow_noRamp: ls_staticShip_acclamator_landed_noRamp {
    author = AUTHOR;
