class ls_staticShip_recusant: ls_staticShip_multiPart_base {
    ...
    EGVAR(map,icon) = QPATHTOF(data\ui\map\recusant_ui_ca.paa);
    EGVAR(map,size) = 593.492;
...
class ls_staticShip_recusant_dreadnought_zeus: ls_staticShip_recusant_zeus {
    author = AUTHOR;
    displayName = "Recusant Dreadnought (Zeus)";
    EGVAR(map,name) = "Recusant Dreadnought";
...
DEPRECATED(ls_recusant_zeus_d,ls_staticShip_recusant_dreadnought_zeus);
DEPRECATED(ls_staticShip_recusant_zeus_dreadnought,ls_staticShip_recusant_dreadnought_zeus);
