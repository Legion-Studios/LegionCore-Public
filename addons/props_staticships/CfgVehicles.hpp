class CfgVehicles {
    ...
    class ls_staticShip_base: House_F {
        ...
        // Models should face -Y in blender, and are rotated in-engine
        // This matches how vanilla handles units/vehicles. Most props don't have the reversed flag so they visually face the wrong way
        reversed = 1;
    };
