class CfgVehicles {
    ...
    #include "helmets\armorer\CfgVehicles.hpp"
    #include "helmets\dinDjarin\CfgVehicles.hpp"
    #include "helmets\elite\CfgVehicles.hpp"
    #include "helmets\executioner\CfgVehicles.hpp"
    #include "helmets\nightowl\CfgVehicles.hpp"
    #include "helmets\stalker\CfgVehicles.hpp"
    #include "helmets\traditional\CfgVehicles.hpp"
