HELMET_GH(CSTRING(superCommando_grunt_helmet),ls_mandalorianHelmet_superCommandoGrunt);
HELMET_GH(CSTRING(superCommando_sergeant_helmet),ls_mandalorianHelmet_superCommandoSergeant);
HELMET_GH(CSTRING(superCommando_captain_helmet),ls_mandalorianHelmet_superCommandoCaptain);
...
class ls_mandalorian_superCommandoMarksman: ls_mandalorian_superCommandoWarrior {
    ...
    weapons[] = {"ls_weapon_mercenarySniper", THROW_PUT};
    respawnWeapons[] = {"ls_weapon_mercenarySniper", THROW_PUT};
...
class ls_mandalorian_superCommandoHeavyAT: ls_mandalorian_superCommandoAT {
    ...
    weapons[] = {"ls_weapon_westar35c", "ls_weapon_westar35sa", "ls_weapon_plx1", THROW_PUT};
    respawnWeapons[] = {"ls_weapon_westar35c", "ls_weapon_westar35sa", "ls_weapon_plx1", THROW_PUT};
...
class ls_mandalorian_superCommandoDemo: ls_mandalorian_superCommandoWarrior {
    ...
    magazines[] = {"ls_magazine_40mm_3Rnd_IM41_HE"};
    respawnMagazines[] = {"ls_magazine_40mm_3Rnd_IM41_HE"};
