...
class ls_mandalorian_traditionalHeavy: ls_mandalorian_base {
    scope = 2;
    author = AUTHOR;
    displayName = ECSTRING(units_mandalorian,warrior_heavy);
...
class ls_mandalorian_traditionalMedic: ls_mandalorian_base {
    scope = 2;
    author = AUTHOR;
    displayName = ECSTRING(units,medic);
...
class ls_mandalorian_traditionalAT: ls_mandalorian_base {
    scope = 2;
    author = AUTHOR;
    displayName = ECSTRING(units_mandalorian,warrior_at);
...
class ls_mandalorian_traditionalDemo: ls_mandalorian_base {
    ...
    magazines[] = {ITEM_3("ls_magazine_40mm_3Rnd_IM41_HE")};
    respawnMagazines[] = {ITEM_3("ls_magazine_40mm_3Rnd_IM41_HE")};
