class ls_mandalorianHelmet_dinDjarin: ls_mandalorianHelmet_traditional {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(dinDjarin_helmet);
...
class ls_mandalorianHelmet_dinDjarin_beskar: ls_mandalorianHelmet_dinDjarin {
    author = AUTHOR;
    displayName = CSTRING(dinDjarin_beskar_helmet);
...
DEPRECATED(ls_mandalorian_dinDjarin_helmet,ls_mandalorianHelmet_dinDjarin);
DEPRECATED(ls_mandalorian_dinDjarinBeskar_helmet,ls_mandalorianHelmet_dinDjarin_beskar);
