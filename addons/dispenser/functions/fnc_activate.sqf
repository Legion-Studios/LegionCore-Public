 ...
 * 2: Spawn limit (optional, 50) <NUMBER>
 *    - Max number of units to spawn, -1 = unlimited
 *
 * Return Value:
 * None
 *
 ...
 * [_dispenser, ["ls_droid_b1", "ls_droid_b2"], 5] call ls_dispenser_fnc_activate;
 *
 * Public: Yes
 */
...
params [
    ...
    ["_spawnGroup", "", ["", []]],
    ["_spawnLimit", SPAWN_LIMIT_DEFAULT, [0]]
];
...
}, [_dispenser, _spawnGroup, _spawnLimit]] call CBA_fnc_waitUntilAndExecute;
