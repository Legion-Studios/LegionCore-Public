class ACE_Arsenal_Stats {
    class ls_statBase;
    class GVAR(strength): ls_statBase {
        scope = 2;
        displayName = "Jetpack Strength";
        stats[] = {QGVAR(strength)};
        showBar = 1;
        showText = 1;
        barStatement = QUOTE(STAT_BAR_STATEMENT(0,JETPACK_STRENGTH_DEFAULT * 1.5));
    ...
    class GVAR(fuel): GVAR(strength) {
        ...
        stats[] = {QGVAR(fuel)};
        barStatement = QUOTE(STAT_BAR_STATEMENT(0,JETPACK_FUEL_DEFAULT * 1.5));
