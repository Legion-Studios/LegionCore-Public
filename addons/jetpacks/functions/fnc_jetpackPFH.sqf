 ...
 *
 * Example:
 * [ls_player, backpackContainer ls_player, 5, 5, -1] call ls_jetpacks_fnc_jetpackPFH;
 *
 * Public: No
 */
...
if (_unit isNotEqualTo ls_player) exitWith {};

private _function = {
    params ["", "_unit", "", "_strength", "_speed"];
    TRACE_3("Jetpack PFH",_unit,_strength,_speed);
