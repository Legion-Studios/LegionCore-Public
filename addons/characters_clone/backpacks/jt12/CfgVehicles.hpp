class ls_cloneBackpack_jt12: ls_backpack_base {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(JT12);

    model = QPATHTOF(backpacks\jt12\ls_backpack_clone_jt12.p3d);
    hiddenSelections[] = {"camo1"};
    hiddenSelectionsTextures[] = {QPATHTOF(backpacks\jt12\data\camo1_co.paa)};
    picture = QPATHTOF(data\ui\jt12Backpack_ui_ca.paa);
