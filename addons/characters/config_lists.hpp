...
"ls_opfor_unit_base", \
"ls_indfor_unit_base", \
"ls_civilian_unit_base", \
"ls_character_pathfinder_base", \
"ls_character_pathfinder_brown_base", \
"ls_character_pathfinder_navy_base", \
"ls_character_pathfinder_navy_alt_base", \
"ls_character_pathfinder_base_r", \
"ls_character_pathfinder_brown_base_r", \
"ls_character_pathfinder_navy_base_r", \
"ls_character_pathfinder_navy_alt_base_r", \
"ls_character_spacer_base", \
"ls_character_spacer_alt_base", \
"ls_character_spacer_brown_base", \
"ls_character_spacer_brown_alt_base", \
"ls_uniform_naval", \
"ls_backpack_base", \
"ls_backpack_hawkbat", \
"ls_backpack_hawkbat_reserve", \
"ls_parachute_hawkbat_steerable", \
"ls_parachute_hawkbat_steerable_reserve", \
"ls_helmet_gunslinger_GH"
