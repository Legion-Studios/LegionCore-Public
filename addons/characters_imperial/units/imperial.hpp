class ls_imperial_army_heavy: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_heavy);
    ...
    backpack = "ls_backpack_chestRig";
};

class ls_imperial_army_heavy_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_heavy);
...
class ls_imperial_army_shotgun: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_shotgun);
...
class ls_imperial_army_shotgun_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_shotgun);
...
class ls_imperial_army_marksman: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_marksman);
...
class ls_imperial_army_marksman_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_marksman);
...
class ls_imperial_army_grenadier: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_grenadier);
    ...
    magazines[] = {
        ITEM_5("ls_magazine_40mm_3Rnd_IM41_HE"),
        ITEM_2("SmokeShell"),
        ITEM_2("ls_grenade_n20_magazine")
    };
    respawnMagazines[] = {
...
class ls_imperial_army_grenadier_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_grenadier);
...
class ls_imperial_army_squadleader: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_squadLead);
...
class ls_imperial_army_squadleader_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_squadLead);
...
class ls_imperial_army_at: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_at);
...
class ls_imperial_army_at_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_at);
...
class ls_imperial_army_heavyAT: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_missileAt);
...
class ls_imperial_army_heavyAT_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_missileAt);
...
class ls_imperial_army_heavyAA: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_heavyAa);

    editorPreview = QPATHTOF(data\ui\editorPreviews\ls_imperial_army_heavyAA.jpg);

    weapons[] = {"ls_weapon_e5c", "ls_weapon_e60r", THROW_PUT};
    respawnWeapons[] = {"ls_weapon_e5c", "ls_weapon_e60r", THROW_PUT};
...
class ls_imperial_army_heavyAA_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_heavyAa);
...
class ls_imperial_army_officer: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_officer);
...
class ls_imperial_army_officer_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_officer);
...
class ls_imperial_army_medic: ls_imperial_army_armored {
    author = AUTHOR;
    displayName = CSTRING(army_armored_medic);
...
class ls_imperial_army_medic_r: ls_imperial_army_armored_r {
    author = AUTHOR;
    displayName = CSTRING(army_armored_rolled_medic);
