class ls_imperial_satchel: ls_combatGlasses_base {
    ...
    picture = QPATHTOF(data\ui\satchel_ui_ca.paa);
};

class ls_imperial_satchelOthers: ls_imperial_satchel {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(satchelOthers);
    ...
    picture = QPATHTOF(data\ui\satchelOthers_ui_ca.paa);
};
