//Basic Sounds
soundEngineOnInt[] = {QPATHTOEF(sounds,vehicles\laatc\engine\engine_start_int.wss), 1, 1};
soundEngineOnExt[] = {QPATHTOEF(sounds,vehicles\laatc\engine\engine_start_ext.wss), 4, 1, 600};
soundEngineOffInt[] = {QPATHTOEF(sounds,vehicles\laatc\engine\engine_end_int.wss), 1, 1};
soundEngineOffExt[] = {QPATHTOEF(sounds,vehicles\laatc\engine\engine_end_ext.wss), 4, 1, 600};
...
soundGetIn[] = {
    "\A3\Sounds_F\vehicles2\soft\Mrap_02\Mrap_02_Enter.wss",
    0.446684,
    1
};
soundGetOut[] = {
    "\A3\Sounds_F\vehicles2\soft\Mrap_02\Mrap_02_Exit.wss",
    0.446684,
    1,
    40
};
...
class Sounds {
    class EngineInt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatc\engine\engine_int.wss), 2, 1};
        frequency = "rotorSpeed*(1+rotorThrust/6)*0.8";
        volume = "2 * (1-camPos)*(rotorSpeed factor[0.4,1])";
    };

    class EngineExt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatc\engine\engine_ext.wss), 8, 1, 600};
        frequency = "rotorSpeed*(1+rotorThrust/6)*0.8";
        volume = "camPos*((rotorSpeed-0.72)*4)";
    };

    class RotorInt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatc\rotor_ext.wss), 2, 1};
        frequency = "rotorSpeed * (1-rotorThrust/5) * 1.2";
        volume = "(1-camPos)*(0 max (rotorSpeed-0.1))*(1 + rotorThrust)*0.9";
    };
    class RotorExt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatc\rotor_ext.wss), 8, 1, 1500};
        frequency = "rotorSpeed * (1-rotorThrust/5) * 1.2";
        volume = "camPos*(0 max (rotorSpeed-0.1))*(1 + rotorThrust)";
        cone[] = {1.6, 3.14, 1.6, 0.95};
    };
    class RotorNoiseExt {
        sound[] = {QPATHTOEF(sounds,vehicles\laatc\rotor_swist.wss), 8, 1, 400};
        frequency = 1;
    ...
    class scrubLandInt {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\wheelsInt.wss", 1, 1, 100};
        frequency = 1;
        volume = "2 * (1-camPos) * (scrubLand factor[0.02, 0.05]) * (1 - (lateralMovement factor [0.7,1]))";
    };
    class scrubLandExt {
        sound[] = {"\A3\Sounds_F\dummysound.wss", 1, 1, 100};
        frequency = 1;
    ...
    class SlingLoadDownInt {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\SL_engineDownINT.wss", 1, 1, 500};
        frequency = 1;
        volume = "(1-camPos)*(slingLoadActive factor [0,-1])";
    };
    class SlingLoadUpInt {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\SL_engineUpINT.wss", 1, 1, 500};
        frequency = 1;
        volume = "(1-camPos)*(slingLoadActive factor [0,1])";
    };
    class WindInt {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\wind_closed.wss", 0.707946, 1, 50};
        frequency = 1;
        volume = "(1-camPos)*(speed factor[5, 60])*(speed factor[5, 60])";
    };
    class GStress {
        sound[] = {"\A3\Sounds_F\vehicles\noises\vehicle_stress2d.wss", 1.12202, 1, 50};
        frequency = 1;
        volume = "engineOn * (1-camPos) * ((gmeterZ factor[1.5, 2.5]) + (gmeterZ factor[0.5, -0.5]))";
    };
    class SpeedStress {
        sound[] = {"\A3\Sounds_F\vehicles\noises\vehicle_stress3.wss", 1, 1, 50};
        frequency = 1;
        volume = "(1-camPos)*(speed factor[40,80])";
    };
    class damageAlarmInt {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\heli_alarm_bluefor.wss", 0.316228, 1};
        frequency = 1;
        volume = "engineOn * (1 - camPos) * ( 1 - ((transmissionDamage factor [0.61, 0.60]) * (motorDamage factor [0.61, 0.60]) * (rotorDamage factor [0.51, 0.50]))) * (rotorSpeed factor [0.0, 0.001])";
    };
    class damageAlarmExt {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\heli_alarm_bluefor.wss", 0.223872, 1, 20};
        frequency = 1;
    ...
    class TransmissionDamageExt_phase1 {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\heli_damage_transmission_ext_1.wss", 1, 1, 150};
        frequency = "0.66 + rotorSpeed / 3";
        volume = "camPos * (transmissionDamage factor [0.3, 0.35]) * (transmissionDamage factor [0.5, 0.45]) * (rotorSpeed factor [0.2, 0.5])";
    };
    class TransmissionDamageExt_phase2 {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\heli_damage_transmission_ext_2.wss", 1, 1, 150};
        frequency = "0.66 + rotorSpeed / 3";
        volume = "camPos * (transmissionDamage factor [0.45, 0.5]) * (rotorSpeed factor [0.2, 0.5])";
    };
    class TransmissionDamageInt_phase1 {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\heli_damage_transmission_int_1.wss", 1, 1, 150};
        frequency = "0.66 + rotorSpeed / 3";
        volume = "(1 - camPos) * (transmissionDamage factor [0.3, 0.35]) * (transmissionDamage factor [0.5, 0.45]) * (rotorSpeed factor [0.2, 0.5])";
    };
    class TransmissionDamageInt_phase2 {
        sound[] = {"\A3\Sounds_F\vehicles\air\noises\heli_damage_transmission_int_2.wss", 1, 1, 150};
        frequency = "0.66 + rotorSpeed / 3";
