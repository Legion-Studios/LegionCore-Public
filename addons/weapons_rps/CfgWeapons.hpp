...
class CfgWeapons {
    ...
    class ls_weapon_rps6_base: ls_launcher_base {
        ...
        handAnim[] = {"OFP2_ManSkeleton", QPATHTOF(anims\rps6_handanim.rtm)};
    ...
    class ls_weapon_rps6_disposable: ls_weapon_rps6_base {
        scope = 1;
        author = AUTHOR;
        displayName = CSTRING(rps6_disposable_displayName);
        descriptionShort = ECSTRING(weapons,disposableLauncher);
    ...
    class ls_weapon_rps6_used: ls_weapon_rps6_disposable {
        scope = 1;
        author = AUTHOR;
        displayName = CSTRING(rps6_used_displayName);
        descriptionShort = ECSTRING(weapons,usedRocketLauncher);
