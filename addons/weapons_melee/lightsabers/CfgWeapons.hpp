// TODO: Wubbsy commisioned lightsaber stuff, rework when that's done
// class ls_bipod_lightsaber_body_base: ItemCore {
//     scope = 0;
//     author = AUTHOR;
...
//         deployedPivot = "";
//         hasBipod = 0;
//         soundBipodDown[] = {"", 0, 1, 1};
//         soundBipodUp[] = {"", 0, 1, 1};
//     };
// };
// class ls_muzzle_lightsaber_emitter_base: ItemCore {
//     scope = 0;
//     author = AUTHOR;
//     picture = QPATHTOEF(main,data\ui\ls_logo_ca.paa);
...
//     };
// };
// class ls_cows_lightsaber_grip_base: ItemCore {
//     scope = 0;
//     author = AUTHOR;
//     picture = QPATHTOEF(main,data\ui\ls_logo_ca.paa);
...
//     };
// };
// class ls_pointer_lightsaber_pommel_base: ItemCore {
//     scope = 0;
//     author = AUTHOR;
//     picture = QPATHTOEF(main,data\ui\ls_logo_ca.paa);
