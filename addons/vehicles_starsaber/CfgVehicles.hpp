...
class CfgVehicles {
    ...
    class ls_vehicle_starsaber_base: VTOL_Base_F {
        ...
        picture = QPATHTOF(data\ui\icon_ca.paa);
        overviewPicture = QPATHTOF(data\ui\icon_ca.paa);
        ...
        class damage {
            tex[] = {};
            mat[] = {
                QPATHTOF(data\camo1.rvmat), "A3\Air_F_EPC\Plane_CAS_01\Data\plane_cas_01_ext01_damage.rvmat", "A3\Air_F_EPC\Plane_CAS_01\Data\plane_cas_01_ext01_destruct.rvmat"
            };
        };
        accuracy = 0.5;
