class ls_acpa_Shot_SoundSet {
    soundShaders[] = {"ls_acpa_closure_SoundShader", "ls_acpa_closeShot_SoundShader", "ls_acpa_midShot_SoundShader", "ls_acpa_distShot_SoundShader"};
    volumeFactor = 1.1;
