class ls_ls150_Shot_SoundSet {
    soundShaders[] = {"ls_ls150_closure_SoundShader", "ls_ls150_closeShot_SoundShader", "ls_ls150_midShot_SoundShader", "ls_ls150_distShot_SoundShader"};
    volumeFactor = 1.2;
