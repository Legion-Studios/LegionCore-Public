class ls_dc15s_Shot_SoundSet {
    soundShaders[] = {"ls_dc15s_closure_SoundShader", "ls_dc15s_closeShot_SoundShader", "ls_dc15s_midShot_SoundShader", "ls_dc15s_distShot_SoundShader"};
    volumeFactor = 1.2;
