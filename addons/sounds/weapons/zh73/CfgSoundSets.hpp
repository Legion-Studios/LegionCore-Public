class ls_zh73_Shot_SoundSet {
    soundShaders[] = {"ls_zh73_closure_SoundShader", "ls_zh73_closeShot_SoundShader", "ls_zh73_midShot_SoundShader", "ls_zh73_distShot_SoundShader"};
    volumeFactor = 1;
