class ls_z95_ForsageExt_SoundShader {
    samples[]= {
        {"A3\Sounds_F_Jets\vehicles\air\Plane_Fighter_01\B_PLANE_FIGHTER_01_engine_forsage_ext.wss", 1}
    };
    frequency = 1.1;
...
class ls_z95_ForsageInt_SoundShader {
    samples[] = {
        {"A3\Sounds_F_Jets\vehicles\air\Plane_Fighter_01\B_PLANE_FIGHTER_01_engine_forsage_int.wss", 1}
    };
    frequency = "1.0 min (rpm + 0.5)*(rpm factor[0, 1])";
