class lsd_gar_p2Commander_nvg: ls_nvg_base {
    ...
    ace_nightvision_border = QPATHTOF(equipment\nvgs\commander\lsd_gar_commander_optic_ca.paa);
...
class lsd_gar_p2Commander_hologram_nvg: lsd_gar_p2Commander_nvg {
    ...
    hiddenSelectionsMaterials[] = {
        ...
        QPATHTOF(equipment\nvgs\common\hologram\camo1.rvmat),
        "" // Assigning the material here would unhide the marshal commander part
    };
...
class lsd_gar_p2MarshalCommander_hologram_nvg: lsd_gar_p2MarshalCommander_nvg {
    author = AUTHOR;
...
class lsd_gar_p1MarshalCommander_hologram_nvg: lsd_gar_p1MarshalCommander_nvg {
    author = AUTHOR;
