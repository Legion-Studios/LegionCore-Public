class lsd_gar_phase2_base: ls_clone_unit_base {
    ...
    magazines[] = {ITEM_10("ls_magazine_dc15a"), ITEM_2("ls_magazine_dc17s"),ITEM_2("SmokeShell"), ITEM_2("ls_grenade_n20_magazine")};
    respawnMagazines[] = {ITEM_10("ls_magazine_dc15a"), ITEM_2("ls_magazine_dc17s"),ITEM_2("SmokeShell"), ITEM_2("ls_grenade_n20_magazine")};
