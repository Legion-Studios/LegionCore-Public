class ls_chiss_male1_blue: ls_default {
    disabled = 0;
    author = AUTHOR;
    displayName = CSTRING(chiss_male1_blue);
...
class ls_chiss_male2_blue: ls_chiss_male1_blue {
    author = AUTHOR;
    displayName = CSTRING(chiss_male2_blue);
    head = "AsianHead_A3";
...
class ls_chiss_male3_blue: ls_chiss_male1_blue {
    author = AUTHOR;
    displayName = CSTRING(chiss_male3_blue);
    head = "GreekHead_A3";
...
class ls_chiss_male1_ice: ls_chiss_male1_blue {
    author = AUTHOR;
    displayName = CSTRING(chiss_male1_ice);
...
class ls_chiss_male2_ice: ls_chiss_male1_ice {
    author = AUTHOR;
    displayName = CSTRING(chiss_male2_ice);
    head = "AsianHead_A3";
...
class ls_chiss_male3_ice: ls_chiss_male1_ice {
    author = AUTHOR;
    displayName = CSTRING(chiss_male3_ice);
    head = "GreekHead_A3";
...
class ls_chiss_male1_purple: ls_chiss_male1_ice {
    author = AUTHOR;
    displayName = CSTRING(chiss_male1_purple);
...
class ls_chiss_male2_purple: ls_chiss_male1_purple {
    author = AUTHOR;
    displayName = CSTRING(chiss_male2_purple);
    head = "AsianHead_A3";
...
class ls_chiss_male3_purple: ls_chiss_male1_purple {
    author = AUTHOR;
    displayName = CSTRING(chiss_male3_purple);
    head = "GreekHead_A3";
