class CfgFaces {
    ...
    class Man_A3: Default {
        ...
        class ls_activeCamo: Default {
            author = AUTHOR;
            displayName = CSTRING(activeCamoFace);

            head = "ls_activeCamo";
            identityTypes[] = {"ls_head_activeCamo"};
    ...
    class ls_droideka: Default {
        class Default;
        class ls_droideka: Default {
            author = AUTHOR;
            displayName = CSTRING(hideHead);
            head = "ls_head_droideka";
            identityTypes[] = {"ls_head_droideka"};
        };
    };

    class ls_atrt: Default {
        class Default;
        class ls_atrt: Default {
            author = AUTHOR;
            displayName = CSTRING(hideHead);
            head = "ls_head_atrt";
            identityTypes[] = {"ls_head_atrt"};
        };
    };
};
