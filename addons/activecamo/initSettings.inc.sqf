...
[
    ...
    ["Cooldown After Deactivating", "Time in seconds after deactivating before active camo can be re-activated."],
    _category,
    [0, 30, 5, -1], 1
] call CBA_fnc_addSetting;
...
[
    ...
    ["Allow Firing", "If enabled, players' active camo will be deactivated when shooting."],
    _category, true, 1
] call CBA_fnc_addSetting;

[
    QGVAR(maxAllowedHits), "SLIDER",
    ["Maximum Allowed Hits", "Allowed number of hits a player can take when in active camo. -1 = Don't deactivate."],
    _category,
    [-1, 30, 5, -1], 1
] call CBA_fnc_addSetting;