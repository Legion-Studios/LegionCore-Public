class ls_weapon_dc15br_base: ls_rifle_base {
    ...
    class Burst: Mode_Burst {
        ...
        sounds[] = {"StandardSound"};
        class StandardSound {
            begin1[] = {QPATHTOEF(sounds,weapons\dc15a\shot1.wss), 1, 1, 1800};
            begin2[] = {QPATHTOEF(sounds,weapons\dc15a\shot2.wss), 1, 1, 1800};
            begin3[] = {QPATHTOEF(sounds,weapons\dc15a\shot3.wss), 1, 1, 1800};
            begin4[] = {QPATHTOEF(sounds,weapons\dc15a\shot4.wss), 1, 1, 1800};
            begin5[] = {QPATHTOEF(sounds,weapons\dc15a\shot5.wss), 1, 1, 1800};
            soundBegin[] = {
                "begin1", 0.2,
                "begin2", 0.2,
                "begin3", 0.2,
