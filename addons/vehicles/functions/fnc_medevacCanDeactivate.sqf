 ...
 * Checks if a unit can deactivate a vehicle's trauma center.
 *
 ...
 *
 * Example:
 * [_vehicle, _unit] call ls_vehicles_fnc_medevacCanDeactivate;
 *
 * Public: No
 */
...
TRACE_2("fnc_medevacCanDeactivate",_vehicle,_unit);
