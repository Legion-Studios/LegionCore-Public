class CfgMagazines {
    ...
    class ls_magazine_65x39_500Rnd_blue: ls_vehicleMagazine_base {
        scope = 2;
        author = AUTHOR;
        displayName = CSTRING(65x39_500Rnd_magazine_blue_displayName);
        displayNameShort = CSTRING(65x39_magazine_displayNameShort);
        descriptionShort = CSTRING(65x39_500Rnd_magazine_descriptionShort);
    ...
    MAGAZINE_COLORS(65x39_500Rnd,ls_ammo_65x39);

    class ls_magazine_65x39_250Rnd_blue: ls_magazine_65x39_500Rnd_blue {
        author = AUTHOR;
        displayName = CSTRING(65x39_250Rnd_magazine_blue_displayName);
        descriptionShort = CSTRING(65x39_250Rnd_magazine_descriptionShort);
        count = 250;
    };
    MAGAZINE_COLORS(65x39_250Rnd,ls_ammo_65x39);
