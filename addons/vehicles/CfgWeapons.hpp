...
class CfgWeapons {
    ...
    class ls_weapon_hmg_65x39: HMG_static {
        author = AUTHOR;
        displayName = CSTRING(hmg_65x39_displayName);
        magazines[] = {"ls_magazine_65x39_500Rnd_blue"};
        magazineWell[] = {"ls_magwell_65x39_belt"};

        magazineReloadTime = 5;

        class manual: manual {
            class StandardSound {
                soundSetShot[] = {"ls_e5_Shot_SoundSet", "HMG127mm_static_tail_SoundSet"};
                closure1[] = {"\A3\Sounds_F\weapons\Closure\sfx10.wss", 0.630957, 1, 20};
                closure2[] = {"\A3\sounds_f\weapons\closure\sfx11.wss", 0.630957, 1.2, 20};
