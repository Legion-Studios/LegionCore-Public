class ls_memeHelmet_chadimusMaximus: ls_helmet_base {
    scope = 2;
    author = AUTHOR;
    displayName = "CT-6969 'Chadimus Maximus'";
    ...
    hiddenSelectionsTextures[] = {
        ...
        QPATHTOEF(characters_clone_legacy,helmets\phase1\data\helmet_p1_co.paa),
        QPATHTOEF(characters_clone_legacy,helmets\phase2\data\helmet_co.paa),
        QPATHTOEF(characters_clone_legacy,helmets\phase1\data\helmet_p1_co.paa)
    };
