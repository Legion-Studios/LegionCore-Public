class ls_supplies_emptyResupply: Reammobox_F {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(resupply_empty);
...
class ls_supplies_dc15aResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_dc15a);
    class TransportMagazines {
...
class ls_supplies_dc15sResupply: ls_supplies_dc15aResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_dc15s);
    class TransportMagazines {
...
class ls_supplies_z6Resupply: ls_supplies_dc15aResupply {
    displayName = CSTRING(resupply_republic_z6);
    class TransportMagazines {
...
class ls_supplies_generalResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_general);
    class TransportMagazines {
...
class ls_supplies_rocketResupply: ls_supplies_generalResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_rocket);
    class TransportMagazines {
...
class ls_supplies_grenadeResupply: ls_supplies_generalResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_grenade);
    class TransportMagazines {
...
class ls_supplies_rpsResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_rps6);
    class TransportWeapons {
...
class ls_supplies_plxResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_plx1);
    class TransportWeapons {
        WEAP_XX(ls_weapon_plx1,10);
    };
...
class ls_supplies_e60rResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_cis_e60r);
    class TransportWeapons {
        WEAP_XX(ls_weapon_e60r,10);
    };
...
class ls_supplies_commandoResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_commando);
    class TransportWeapons {
...
class ls_supplies_republicAssaultResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_assault);
    class TransportWeapons {
    ...
    class TransportMagazines {
        ...
        MAG_XX(ls_magazine_40mm_3Rnd_IM41_HE,20);
...
class ls_supplies_droidAssaultResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_cis_droid);
    class TransportWeapons {
...
class ls_supplies_republicSpecOpsResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_republic_specOps);
    class TransportWeapons {
    ...
    class TransportMagazines {
        ...
        MAG_XX(ls_magazine_40mm_3Rnd_G76_HEF,20);
    };
    class TransportItems {
...
class ls_supplies_eodResupply: ls_supplies_emptyResupply {
    author = AUTHOR;
    displayName = CSTRING(resupply_eod);
