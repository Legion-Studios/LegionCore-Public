 ...
 * Arguments:
 * 0: Unit <OBJECT>
 * 1: How many modes to cycle (optional, default: 1) <NUMBER>
 ...
 *
 * Example:
 * [player, 1] call ls_lighting_fnc_cycleMode;
 *
 * Public: Yes
 */
