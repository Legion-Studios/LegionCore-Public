...
soundEngineOffInt[] = {QPATHTOEF(sounds,vehicles\speeder\idle.wss), "db-8", 1.0};
soundEngineOffExt[] = {QPATHTOEF(sounds,vehicles\speeder\idle.wss), "db-7", 1.0, 200};
...
class Sounds {
    ...
    class Engine5_Thrust_ext {
        sound[] = {QPATHTOEF(sounds,vehicles\105kLancer\thrust_5.wss), "db-2", 1, 450};
