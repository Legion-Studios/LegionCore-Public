class ls_jabiim_nimbusCommando_grenadier: ls_jabiim_nimbusCommando {
    ...
    magazines[] = {ITEM_3("ls_magazine_40mm_3Rnd_IM41_HE"), ITEM_3("ls_magazine_rg4d")};
    respawnMagazines[] = {ITEM_3("ls_magazine_40mm_3Rnd_IM41_HE"), ITEM_3("ls_magazine_rg4d")};
...
class ls_jabiim_nimbusCommando_Sniper: ls_jabiim_nimbusCommando {
    ...
    weapons[] = {"ls_weapon_mercenarySniper", "ls_weapon_rg4d", THROW_PUT};
    respawnWeapons[] = {"ls_weapon_mercenarySniper", "ls_weapon_rg4d", THROW_PUT};
...
class ls_jabiim_nimbusCommando_heavyAA: ls_jabiim_nimbusCommando {
    ...
    weapons[] = {"ls_weapon_e5", "ls_weapon_rg4d", "ls_weapon_e60r", THROW_PUT};
    respawnWeapons[] = {"ls_weapon_e5", "ls_weapon_rg4d", "ls_weapon_e60r", THROW_PUT};
