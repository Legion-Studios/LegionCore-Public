class CfgAmmo {
    // ls_ammo_<CALIBER>_<COLOR> or
    // ls_ammo_<CALIBER>_pistol_<COLOR>
    AMMO(45ACP,B_45ACP_Ball);
    AMMO(9x21,B_9x21_Ball);
    AMMO(93x64,B_93x64_Ball);
    AMMO_PISTOL(93x64);
    AMMO(556x45,B_556x45_Ball);
    AMMO(570x28,B_570x28_Ball);
    AMMO(65x39,B_65x39_Caseless);
    AMMO(762x39,B_762x39_Ball_F);
    AMMO(762x51,B_762x51_Ball);
    AMMO(762x54,B_762x54_Ball);
    AMMO(338,B_338_Ball);
    AMMO(338_NM,B_338_NM_Ball);
    AMMO(408,B_408_Ball);
    AMMO(30mm_AP,B_30mm_AP);
    AMMO(127x108,B_127x108_Ball);

    // TODO: Rename to generic ammo, rather than AT-RT specific
    class ls_ammo_atrt_30mm_AP_blue: ls_ammo_30mm_AP_blue {
        soundSetExplosion[] = {};
    ...
    AMMO(12Gauge_Slug,B_12Gauge_Slug);

    class B_12Gauge_Pellets_Submunition;
    class ls_ammo_12Gauge_Pellets_Submunition: B_12Gauge_Pellets_Submunition {
        submunitionAmmo = "ls_ammo_12Gauge_Pellets_Submunition_Deploy";
        cost = 0.3; // 1 // lowered so AI are more incentivised to use shotguns
        class HitEffects;
    };
    class ls_ammo_12Gauge_Pellets_Submunition_blue: ls_ammo_12Gauge_Pellets_Submunition {
        submunitionAmmo = "ls_ammo_12Gauge_Pellets_Submunition_Deploy_blue";
    ...
    class ls_ammo_12Gauge_Pellets_Submunition_red: ls_ammo_12Gauge_Pellets_Submunition_blue {
        submunitionAmmo = "ls_ammo_12Gauge_Pellets_Submunition_Deploy_red";
        model = QPATHTOEF(data,effects\ls_laser_red.p3d);
        effectFly = "ls_plasma_red";
    };
    class ls_ammo_12Gauge_Pellets_Submunition_green: ls_ammo_12Gauge_Pellets_Submunition_blue {
        submunitionAmmo = "ls_ammo_12Gauge_Pellets_Submunition_Deploy_green";
        model = QPATHTOEF(data,effects\ls_laser_green.p3d);
        effectFly = "ls_plasma_green";
    };
    class ls_ammo_12Gauge_Pellets_Submunition_yellow: ls_ammo_12Gauge_Pellets_Submunition_blue {
        submunitionAmmo = "ls_ammo_12Gauge_Pellets_Submunition_Deploy_yellow";
        model = QPATHTOEF(data,effects\ls_laser_yellow.p3d);
        effectFly = "ls_plasma_yellow";
    };
    AMMO(12Gauge_Pellets_Submunition_Deploy,B_12Gauge_Pellets_Submunition_Deploy);
