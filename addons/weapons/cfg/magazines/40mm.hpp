class ls_2Rnd_40mw_G77_HEAB_mag: ls_magazine_base {
    scope = 2;
...
class ls_3Rnd_40mw_IM41_mag: ls_magazine_base {
    scope = 2;
    type = 16;
...
class ls_2Rnd_40mw_IM41_mag: ls_3Rnd_40mw_IM41_mag {
    displayName = "IM41 High Explosive Shell (x2)";
    displayNameShort = "IM41 HE (x2)";
    mass = 10;
};

class ls_3Rnd_40mw_IM92F_mag: ls_magazine_base {
    scope = 2;
    type = 16;
...
class ls_2Rnd_40mw_IM92F_mag: ls_3Rnd_40mw_IM92F_mag {
    displayName = "IM92F Fragmentation Shell (x2)";
    displayNameShort = "IM92F Frag (x2)";
    mass = 10;
};

class ls_3Rnd_40mw_IM304D_mag: ls_magazine_base {
    scope = 2;
    type = 16;
...
class ls_2Rnd_40mw_IM304D_mag: ls_3Rnd_40mw_IM304D_mag {
...
class ls_2Rnd_40mw_IM334K_mag: ls_magazine_base {
    scope = 2;
    type = 16;
...
class ls_2Rnd_40mw_IM973B_mag: ls_magazine_base {
    scope = 2;
    type = 16;
...
class ls_3Rnd_40mw_G76_HEF_mag: ls_magazine_base {
    scope = 2;
    type = 16;
...
class ls_3Rnd_40mw_G75_HE_mag: ls_magazine_base {
    scope = 2;
    type = 16;
