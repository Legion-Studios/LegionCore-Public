...
#define AMMO_COLORS(AMMO_TYPE,PARENT_CLASS) \
...
#define AMMO(AMMO_TYPE,PARENT_CLASS) \
    ...
    AMMO_COLORS(AMMO_TYPE,PARENT_CLASS)

#define AMMO_NOPARENT(AMMO_TYPE,PARENT_CLASS) \
    AMMO_COLORS(AMMO_TYPE,PARENT_CLASS)

#define AMMO_NOPARENT_NOEFFECTS(AMMO_TYPE,PARENT_CLASS) \
    class TRIPLES(ls_ammo,AMMO_TYPE,blue): DOUBLES(ls_ammo,AMMO_TYPE) { \
        model = QPATHTOEF(data,effects\ls_laser_blue.p3d); \
        effectFly = "ls_plasma_blue"; \
        cartridge = ""; \
