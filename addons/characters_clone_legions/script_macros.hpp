...
#define UNIT_COMMON(LEGION,PHASE,TYPE_OR_NAME,UNIFORM_PHASE) \
    scope = 2; \
    author = AUTHOR; \
    uniformClass = QUOTE(TROOPER_UNIFORM(LEGION,UNIFORM_PHASE)); \
...
#define SPAWN_UNITS_FULL(LEGION,PHASE,UNIFORM_PHASE) \
    class UNIT_CLASS_NAME(LEGION,PHASE,DC15A): UNIT_CLASS_NAME(standard,phase2,DC15A) { \
        UNIT_COMMON(LEGION,PHASE,DC15A,UNIFORM_PHASE); \
    ...
    class UNIT_CLASS_NAME(LEGION,PHASE,lieutenant): UNIT_CLASS_NAME(standard,phase2,lieutenant) { \
        UNIT_COMMON(LEGION,PHASE,lieutenant,UNIFORM_PHASE); \
    ...
    class UNIT_CLASS_NAME(LEGION,PHASE,captain): UNIT_CLASS_NAME(standard,phase2,captain) { \
        UNIT_COMMON(LEGION,PHASE,captain,UNIFORM_PHASE); \
    ...
    class UNIT_CLASS_NAME(LEGION,PHASE,commander): UNIT_CLASS_NAME(standard,phase2,commander) { \
        UNIT_COMMON(LEGION,PHASE,commander,UNIFORM_PHASE); \
