class ls_nvg_clone_commando_antenna_deltaFixer: ls_sob_commando_antenna_nvg {
    author = AUTHOR;
...
class ls_nvg_clone_commando_antenna_omegaAtin: ls_sob_commando_antenna_nvg {
    author = AUTHOR;
...
class ls_nvg_clone_commando_visor_omegaFi: ls_sob_commando_visor_nvg {
    author = AUTHOR;
...
class ls_nvg_clone_commando_visor_mpStealth: ls_sob_commando_visor_nvg {
    author = AUTHOR;
