class ls_clone_rancor_trooper: lsd_gar_phase2_base {
    ...
    editorSubcategory = "ls_edsubcat_clone_rancor_phase2";
...
class ls_clone_rancor_colt: lsd_gar_arc_base {
    ...
    linkedItems[] = {"ls_cloneHelmet_arc_rancor_colt", "ls_cloneVest_arc_rancor_colt", LINKED_ITEMS_CLONE};
    respawnlinkedItems[] = {"ls_cloneHelmet_arc_rancor_colt", "ls_cloneVest_arc_rancor_colt", LINKED_ITEMS_CLONE};
};
...
class ls_clone_rancor_blitz: lsd_gar_arc_base {
    ...
    linkedItems[] = {"ls_cloneHelmet_arc_rancor_blitz", "ls_cloneVest_arc_rancor_blitz", LINKED_ITEMS_CLONE};
    respawnlinkedItems[] = {"ls_cloneHelmet_arc_rancor_blitz", "ls_cloneVest_arc_rancor_blitz", LINKED_ITEMS_CLONE};
};
...
class ls_clone_rancor_havoc: lsd_gar_arc_base {
    ...
    linkedItems[] = {"ls_cloneHelmet_arc_rancor_havoc", "ls_cloneVest_arc_rancor_havoc", LINKED_ITEMS_CLONE};
    respawnlinkedItems[] = {"ls_cloneHelmet_arc_rancor_havoc", "ls_cloneVest_arc_rancor_havoc", LINKED_ITEMS_CLONE};
};
