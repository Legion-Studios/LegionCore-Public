...
class ls_clone_501st_echo: lsd_gar_arc_base {
    ...
    editorSubcategory = "ls_edsubcat_clone_501st_phase2";
    editorPreview = QPATHTOF(data\ui\editorPreviews\ls_clone_501st_echo.jpg);

    uniformClass = "ls_cloneUniform_501st_echo";
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\echo_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\echo_lower_co.paa),
...
class ls_clone_501st_fives: lsd_gar_arc_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\fives_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\fives_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
class ls_clone_501st_hardcase: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\hardcase_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\hardcase_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
class ls_clone_501st_jesse: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\jesse_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\jesse_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
class ls_clone_501st_rex: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\rex_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\rex_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
class ls_clone_501st_dogma: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\dogma_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\dogma_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
class ls_clone_501st_tup: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\tup_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\tup_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
class ls_clone_501st_kix: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\501st\data\uniforms\legacy\kix_upper_co.paa),
        QPATHTOF(units\501st\data\uniforms\legacy\kix_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
SPAWN_UNITS_FULL(501st,phase2,phase2);
