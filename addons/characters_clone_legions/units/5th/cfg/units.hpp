...
class ls_clone_5th_medic: lsd_gar_phase2_base {
    scope = 1;
    author = AUTHOR;
    displayName = "Clone Medic";

    faction = "ls_gar_legions";
    editorSubcategory = "ls_edsubcat_clone_5th_phase2";
...
class ls_clone_5th_nco: lsd_gar_phase2_base {
    scope = 1;
    author = AUTHOR;
...
class ls_clone_5th_officer: lsd_gar_phase2_base {
    scope = 1;
    author = AUTHOR;
...
SPAWN_UNITS_FULL(5th,phase2,phase2);
