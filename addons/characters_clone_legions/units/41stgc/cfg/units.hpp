class ls_clone_41stgc_trooper: lsd_gar_phase2_base {
    ...
    editorSubcategory = "ls_edsubcat_clone_41stgc_phase2";
...
class ls_clone_41stgc_AT_heavy: ls_clone_41stgc_AT {
    ...
    weapons[] = {"ls_weapon_dc15s", "ls_weapon_dc17s","ls_weapon_plx1", THROW_PUT};
    respawnWeapons[] = {"ls_weapon_dc15s", "ls_weapon_dc17s","ls_weapon_plx1", THROW_PUT};
