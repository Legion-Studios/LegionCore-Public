...
class ls_clone_41st_officer: ls_clone_41st_trooper {
    scope = 2;
    author = AUTHOR;
    displayName = "Clone Officer";

    editorPreview = QPATHTOF(data\ui\editorPreviews\ls_clone_41st_officer.jpg);
    ...
    linkedItems[] = {"ls_gar_phase2_helmet", "ls_gar_officer_vest", "lsd_gar_p2Commander_nvg", LINKED_ITEMS_CLONE};
    respawnlinkedItems[] = {"ls_gar_phase2_helmet", "ls_gar_officer_vest", "lsd_gar_p2Commander_nvg", LINKED_ITEMS_CLONE};
};
