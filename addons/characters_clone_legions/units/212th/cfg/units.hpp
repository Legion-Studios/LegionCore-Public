...
class ls_clone_212th_airborne: lsd_gar_phase2_base {
    ...
    editorSubcategory = "ls_edsubcat_clone_212th_phase2";
...
class ls_clone_212th_airborne_nco: ls_clone_212th_airborne {
    displayName = "Clone Airborne Sergeant";
    ROLE_LEADER;
    linkedItems[] = {QUOTE(ls_cloneHelmet_airborne_212th_trooper),QUOTE(ls_gar_airborneNCO_vest),LINKED_ITEMS_CLONE};
    respawnlinkedItems[] = {QUOTE(ls_cloneHelmet_airborne_212th_trooper),QUOTE(ls_gar_airborneNCO_vest),LINKED_ITEMS_CLONE};
};
class ls_clone_212th_airborne_officer: ls_clone_212th_airborne_nco {
    displayName = "Clone Airborne Lieutenant";
    ROLE_OFFICER;
    linkedItems[] = {QUOTE(ls_cloneHelmet_airborne_212th_trooper),QUOTE(ls_gar_airborneOfficer_vest),LINKED_ITEMS_CLONE};
    respawnlinkedItems[] = {QUOTE(ls_cloneHelmet_airborne_212th_trooper),QUOTE(ls_gar_airborneOfficer_vest),LINKED_ITEMS_CLONE};
};

SPAWN_UNITS_FULL(212th,phase2,phase2);
