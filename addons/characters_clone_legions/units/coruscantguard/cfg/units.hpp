P2_UNIT(coruscantguard,trooper);
...
class ls_clone_coruscantguard_thorn: lsd_gar_phase2_base {
    ...
    editorSubcategory = "ls_edsubcat_clone_coruscantguard_phase2";
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\coruscantguard\data\uniforms\legacy\thorn_upper_co.paa),
        QPATHTOF(units\coruscantguard\data\uniforms\legacy\thorn_lower_co.paa),
...
class ls_clone_coruscantguard_fox: lsd_gar_phase2_base {
    ...
    hiddenSelectionsTextures[] = {
        QPATHTOF(units\coruscantguard\data\uniforms\legacy\fox_upper_co.paa),
        QPATHTOF(units\coruscantguard\data\uniforms\legacy\fox_lower_co.paa),
        QPATHTOEF(characters_clone_legacy,uniforms\phase2\data\undersuit_co.paa)
    };
...
SPAWN_UNITS_FULL(coruscantguard,phase2,phase2);
