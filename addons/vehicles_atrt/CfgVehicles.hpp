class CfgVehicles {
    ...
    class ls_vehicle_atrt_base: ls_blufor_unit_base {
        ...
        movesFatigue = "CfgMovesFatigueNoSlowdown_ls";
        gestures = "";
        ...
        armor = 4;
        impactDamageMultiplier = 0.25; // Default for CAManBase is 0.5

        #define ATRT_ARMOR 45
    ...
    class ls_vehicle_atrt: ls_vehicle_atrt_base {
        scope = 2;
        author = AUTHOR;
        editorPreview = QPATHTOF(data\ui\editorPreviews\ls_vehicle_atrt.jpg);
    ...
    class ls_vehicle_atrt_rotaryBlaster: ls_vehicle_atrt {
        ...
        editorPreview = QPATHTOF(data\ui\editorPreviews\ls_vehicle_atrt_rotaryBlaster.jpg);
    ...
    class ls_vehicle_atrt_flamethrower: ls_vehicle_atrt {
        ...
        // editorPreview = QPATHTOF(data\ui\editorPreviews\ls_vehicle_atrt_flamethrower.jpg);
    };

    LEGION_ATRT(41strb,phase2,ls_clone_phase2_41strb_atrtDriver);
