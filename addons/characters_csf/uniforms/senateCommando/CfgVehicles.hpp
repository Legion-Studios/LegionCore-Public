class ls_csf_senateCommando: ls_clone_unit_base {
    scope = 1;
...
class ls_csf_senateCommando_guardsman: ls_csf_senateCommando {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(senateCommando);
...
class ls_csf_senateCommando_lieutenant: ls_csf_senateCommando {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(senateCommando_lieutenant);
...
class ls_csf_senateCommando_captain: ls_csf_senateCommando {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(senateCommando_captain);
...
class ls_csf_senateCommando_hologram: ls_csf_senateCommando {
    scope = 2;
    author = AUTHOR;
    displayName = CSTRING(senateCommando_hologram);
