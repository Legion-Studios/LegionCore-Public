 ...
 *
 * Example:
 * ["Place Explosive", "Cancel"] call ls_common_fnc_showMouseHint
 *
 * Public: No
 */

params ["_textLMB", "_textRMB", ["_textMMB", ""], ["_extraIconSets", []]];
TRACE_4("fnc_showMouseHint",_textLMB,_textRMB,_textMMB,_extraIconSets);
...
// Create extra icon sets
{
    ...
    if (_keyName != "" && _keyText != "") then {
        ...
        private _ctrlGroup = _display ctrlCreate [QGVAR(RscMouseHintExtra), IDC_MOUSEHINT_EXTRA];
