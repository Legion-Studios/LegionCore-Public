class ls_droid_b2: ls_droid_base {
    ...
    magazines[] = {ITEM_8("ls_magazine_wristblaster_B2"), ITEM_2("ls_magazine_wristblaster_B2_scatter")};
    respawnMagazines[] = {ITEM_8("ls_magazine_wristblaster_B2"), ITEM_2("ls_magazine_wristblaster_B2_scatter")};
