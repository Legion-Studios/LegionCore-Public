class ls_droid_tseries: ls_droid_base {
    ...
    linkedItems[] = {"ls_droidVest", "ls_nvg_invisible", LINKED_ITEMS_DROID};
    respawnLinkedItems[] = {"ls_droidVest", "ls_nvg_invisible", LINKED_ITEMS_DROID};
