class ls_droid_bx_assassain: ls_droid_bx {
    author = AUTHOR;
    displayName = CSTRING(bx_assassain);
...
class ls_droid_bx_impostor: ls_droid_bx {
    author = AUTHOR;
    displayName = CSTRING(bx_impostor);
};

class ls_droid_bx_cloneDisguise_phase2: ls_droid_bx {
    author = AUTHOR;
    displayName = CSTRING(bx_cloneDisguise_phase2);
...
class ls_droid_bx_cloneDisguise_phase1: ls_droid_bx_cloneDisguise_phase2 {
    author = AUTHOR;
    displayName = CSTRING(bx_cloneDisguise_phase1);
